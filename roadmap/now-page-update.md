...
- **Status:** planned
- **Problem/Intent:** The Now page needs a content refresh and a visual "Memento Mori" life chart to visualize time passed/remaining.
- **Constraints:** `pages/now.md` (content) and `src/org_blog/pages/now.clj` (logic).
- **Proposed Approach:**
